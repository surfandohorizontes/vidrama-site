  ...
  **/
	...
	class WideImage
	{
		...
		static function load($source)
		{
			...
			if (!$predictedSourceType && is_string($source) && isset($_FILES[$source]) && isset($_FILES[$source]['tmp_name']))
		...
		{
			return (is_resource($handle) && get_resource_type($handle) == 'gd') || (class_exists('GdImage') && $handle instanceof GdImage);
		}
