function Consultar(){
    ...
    $.ajax({
        ...
        data: {token: token, acao: 'categorias', pesquisa: ''},
            ...
            if(resposta.code == 200){
                ...
                for (let index = 0; index < resposta.dados.length; index++) {
                    ...
                    html += '<tr style="background: #ffffff; color:#000000;">'+
                        '<td style="text-align: center;">'+resposta.dados[index].id+'</td>'+
...
function Editar(id){
    ...
    $.ajax({
        type: "POST",
        url: "../api/private/select",  
        data: {token: token, acao: 'dados_categoria', id: id},
        success: function(resposta) {
...
function Deletar(id){
    ...
    if (r == true) {
        ...
        $.ajax({
            ...
            data: {token: token, acao: 'categoria', id: id},
            success: function(resposta) {
...
function Salvar(){
    ...
    $.ajax({
        ...
        data: { token: token, acao: 'categoria', nome: nome, id: id },
        success: function(resposta) {
...
function Cadastrar(){
    ...
    $.ajax({
        ...
        data: { token: token, acao: 'categoria', nome: nome },
        success: function(resposta) {
...
function Status(id){
    ...
    $.ajax({
        type: "POST",
        url: "../api/private/update",  
        data: {token: token, acao: 'status_categoria', id: id, status: BtnStatus},
        success: function(resposta) {
            if(resposta.code == 200){
